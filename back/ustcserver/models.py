...
class Task(models.Model):
    ...
    score = models.PositiveIntegerField(blank=True, default=0)  # 通过率得分
    score_admin = models.PositiveIntegerField(blank=True, default=0)  # 通过率得分
    fmpath = models.TextField(blank=True, null=False, default='/media/fengmian/default.jpg')
    # user_scored = models.ManyToManyField(settings.AUTH_USER_MODEL)  # https://docs.djangoproject.com/en/3.1/topics/db/examples/many_to_many/
...
# https://www.jianshu.com/p/d50eca3af183
